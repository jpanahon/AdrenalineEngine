...
class Buffers {
public:
	Buffers(VkInstance& instance, Devices& devices) : device(devices.device), allocator(devices.allocator),
		gpu(devices.gpu), graphicsQueue(devices.graphicsQueue), instance(instance) {}
